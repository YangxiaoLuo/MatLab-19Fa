function varargout = exm080301(varargin)
% EXM080301 MATLAB code for exm080301.fig
%      EXM080301, by itself, creates a new EXM080301 or raises the existing
%      singleton*.
%
%      H = EXM080301 returns the handle to a new EXM080301 or the handle to
%      the existing singleton*.
%
%      EXM080301('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EXM080301.M with the given input arguments.
%
%      EXM080301('Property','Value',...) creates a new EXM080301 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before exm080301_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to exm080301_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help exm080301

% Last Modified by GUIDE v2.5 01-Dec-2017 10:03:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @exm080301_OpeningFcn, ...
                   'gui_OutputFcn',  @exm080301_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before exm080301 is made visible.
function exm080301_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to exm080301 (see VARARGIN)
%U_Start-----------------------------------------------------U_Start
zeta=0.3;                                   			% 初始阻尼比
...
%U_End -----------------------------------------------------------------------------------U End
% Choose default command line output for exm080301
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes exm080301 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = exm080301_OutputFcn(hObject, eventdata, handles) 
